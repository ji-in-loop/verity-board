...
import { AnthropicModelProvider } from '../src/anthropic-model-provider.js';
import type { ActorContext, ActorSkill } from '@verity-board/core';

/**
 * Gated behind an explicit opt-in env var — never runs in default CI. This
 * is the only place in the repo that makes a real network call to Anthropic.
 * See docs/phase-0/08-testing-strategy.md.
 */
...
describe.skipIf(!LIVE)('AnthropicModelProvider (live)', () => {
